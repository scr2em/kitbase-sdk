		...
		<div class="grid">
			...
			<div class="card">
				...
				<p style="margin-bottom: 0.75rem; color: #666; font-size: 0.875rem">
					These buttons use <code>data-kb-track-click</code> to fire named events — no TypeScript
					needed.
				</p>
				<div class="btn-group">
					...
					<button data-kb-track-click="Add to Cart">Add to Cart (engagement)</button>
				</div>
			</div>
			...
			<div class="card">
				...
				<p style="margin-bottom: 0.75rem; color: #666; font-size: 0.875rem">
					Scroll these sections into view — the SDK tracks how long each is visible and fires events on
...
export class DashboardComponent {
	...
	listPlugins() {
		...
		this.logService.log(
			`Active plugins: ${plugins.length ? plugins.join(", ") : "(none)"}`,
			"info",
		);
	}
}