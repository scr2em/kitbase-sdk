...
export class FlagsService {
	...
	constructor() {
		...
		const { unsubscribe: unsubscribeFlagChange } = this.client.onFlagChange(
	 ...
	 * ```
	 */
	getBooleanFlag(key: string, options?: FlagSignalOptions): Signal<FlagSignalResult<boolean>> {
		return this.createFlagSignal(key, (k, ctx) => this.client.getBooleanValue(k, ctx), options);
	}
	 ...
	 * @returns A computed signal containing the flag result
	 */
	getStringFlag(key: string, options?: FlagSignalOptions): Signal<FlagSignalResult<string>> {
		return this.createFlagSignal(key, (k, ctx) => this.client.getStringValue(k, ctx), options);
	}
	 ...
	 * @returns A computed signal containing the flag result
	 */
	getNumberFlag(key: string, options?: FlagSignalOptions): Signal<FlagSignalResult<number>> {
		return this.createFlagSignal(key, (k, ctx) => this.client.getNumberValue(k, ctx), options);
	}
	 ...
	 */
	getBooleanFlag$(key: string, context?: EvaluationContext): Observable<boolean> {
		return this.createFlagObservable(key, () => this.client.getBooleanValue(key, context));
	}
	 ...
	 * @returns An Observable that emits the flag value
	 */
	getStringFlag$(key: string, context?: EvaluationContext): Observable<string> {
		return this.createFlagObservable(key, () => this.client.getStringValue(key, context));
	}
	 ...
	 * @returns An Observable that emits the flag value
	 */
	getNumberFlag$(key: string, context?: EvaluationContext): Observable<number> {
		return this.createFlagObservable(key, () => this.client.getNumberValue(key, context));
	}
	...
	getJsonFlag$<T extends JsonValue = JsonValue>(
		...
		return this.createFlagObservable(
			key,
	 ...
	 */
	async getBooleanValue(key: string, context?: EvaluationContext): Promise<boolean> {
	 ...
	 * @returns Promise resolving to the flag value
	 */
	async getStringValue(key: string, context?: EvaluationContext): Promise<string> {
	 ...
	 * @returns Promise resolving to the flag value
	 */
	async getNumberValue(key: string, context?: EvaluationContext): Promise<number> {
