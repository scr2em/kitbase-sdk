...
export default class WebAnalyticsList extends ApiOperationCommand {
	static description = "Get project web analytics summary metrics";
	static flags = {
	...
	descriptor = descriptors["getProjectWebAnalytics"];
}
