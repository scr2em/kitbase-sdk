...
export default class AiVisibilityBreakdown extends ApiOperationCommand {
	static description = "Per-provider breakdown";
	static flags = {
	...
	descriptor = descriptors["getAiVisibilityBreakdown"];
}
