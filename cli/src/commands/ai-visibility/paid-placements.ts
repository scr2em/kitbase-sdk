...
export default class AiVisibilityPaidPlacements extends ApiOperationCommand {
	static description = "Sponsored placements inside AI answers";
	static flags = {
	...
	descriptor = descriptors["getAiVisibilityPaidPlacements"];
}
