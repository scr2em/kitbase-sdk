...
export default class AiVisibilityVisibility extends ApiOperationCommand {
	static description = "Presence-rate time series";
	static flags = {
	...
	descriptor = descriptors["getAiVisibilitySeries"];
}
