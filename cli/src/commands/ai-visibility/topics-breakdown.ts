...
export default class AiVisibilityTopicsBreakdown extends ApiOperationCommand {
	static description = "Per-topic visibility and share of voice";
	static flags = {
	...
	descriptor = descriptors["getAiVisibilityTopicsBreakdown"];
}
