...
export default class AiVisibilityCompetitorSeries extends ApiOperationCommand {
	static description = "Per-competitor presence time series";
	static flags = {
	...
	descriptor = descriptors["getAiVisibilityCompetitorSeries"];
}
