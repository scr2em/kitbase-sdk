...
export default class AiVisibilityDiscoveredCompetitors extends ApiOperationCommand {
	static description = "Suggested (untracked) competitors";
	static flags = {
		"jobs": Flags.integer({ description: "Number of most recent completed jobs to aggregate (ignored when from/to set)" }),
		"limit": Flags.integer({ description: "Maximum number of suggested competitors to return" }),
	...
	descriptor = descriptors["getAiVisibilityDiscoveredCompetitors"];
}
