...
export default class AiVisibilityPromptsBreakdown extends ApiOperationCommand {
	static description = "Per-prompt breakdown";
	static flags = {
	...
	descriptor = descriptors["getAiVisibilityPromptsBreakdown"];
}
