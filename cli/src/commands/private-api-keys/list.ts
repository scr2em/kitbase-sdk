...
export default class PrivateApiKeysList extends ApiOperationCommand {
	static description = "Get private API keys with pagination";
	static flags = {
	...
	descriptor = descriptors["getPrivateApiKeys"];
}
